...
<div id="main">
	...
	<div id="main-part">
				...
				<article class="post post-type real-post">
					<header class="post-type-header">
						...
						<div class="thumbnail-shadow">
							...
							<div class="post-info"><span class="post-category"><i class="zyme zyme-novel"></i> <?php the_category(', '); ?></span>&nbsp;•&nbsp;<span class="post-view"><i class="zyme zyme-view"></i>&nbsp;<?php echo getPostViews(get_the_ID()); ?></span>&nbsp;•&nbsp;<span class="post-comments"><i class="zyme zyme-comment"></i>&nbsp;<?php if (post_password_required()) {
																																																																																																																																																																									echo '<a>密码保护</a>';
																																																																																																																																																																								} else {
		...
		<div class="zyme-item tags_related">
			<header class="zyme-item-header">
				<h3 class="zyme-item-title"><i class="zyme zyme-browser"></i> 相关文章</h3>
			</header>
			<ul id="tags_related">
				<?php
				global $post, $wpdb;
