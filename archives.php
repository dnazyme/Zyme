							...
							<article class="post post-type">
								...
								<header class="post-type-header">
									...
									<div class="post-relative">
										...
										<span class="post-type-author"><?php echo the_author_posts_link(); ?> <i class="zyme zyme-certify"></i><span class="publish-time"> - <?php echo human_time_diff(get_the_time('U'), current_time('timestamp'));
																																																																																_e('前'); ?></span>
										</span>
								...
								<div class="post-main post-type-main">
									<div class="post-content">
										...
										<div class="post-category"><?php _e('来自分类：');
																											the_category(' / '); ?></div>
									</div>
								</div>
								<div class="post-footer">
									...
									<span class="post-comments">
										<i class="zyme zyme-comment"></i>&nbsp;<?php if (post_password_required()) {
																																		echo '<a>密码保护</a>';
																																	} else {
									...
									<span class="post-like">
										<a href="javascript:;" data-action="zyme_like" data-id="<?php the_ID(); ?>" class="like<?php if (isset($_COOKIE['zyme_like_' . $post->ID])) echo ' have-like'; ?>">
											<span class="like-count"><?php if (get_post_meta($post->ID, 'zyme_like', true)) {
					...
					<?php } else if ($post->post_type == 'shuoshuo') { ?>
						<li class="zyme-item">
							<article class="shuoshuo post-type">
								...
								<div class="post-main post-type-main">
									<div class="post-content">
										<div class="post-tag post-content"><?php the_tags('', ' ', '');
																															the_content(); ?></div>
									</div>
								</div>
								<div class="post-footer">
							...
							<article class="art">
								...
								<header class="art-header">
									...
									<h3 class="article-author"><?php echo the_author_posts_link(); ?>
										...
										<span class="normal">发布了一篇<?php if (strlen(get_post_meta(get_the_ID(), '_douban_id', true)) < 9) {
																											echo '影评';
																										} else {
																											echo '书评';
																										} ?></span>
