 ...
 */
	if (isset($_SERVER['SCRIPT_FILENAME']) && 'comments.php' == basename($_SERVER['SCRIPT_FILENAME']))
		die ('请不要直接打开评论模块！');
?>
<div class="zyme-item comment-part">
	<a id="go-to-comment" href="#comments"><i class="zyme zyme-comments"></i></a>
	<header class="zyme-item-header"><h3 class="zyme-item-title"><i class="zyme zyme-comments"></i> 评论</h3></header>
	...
	<div id="comments">
		...
		if ( !comments_open() ) {
		?>
		<ol class="zyme-comments-area"><p class="center"><i class="zyme zyme-error"></i> 评论功能已经关闭!</p></ol>
		<?php
		} else if ( !have_comments() ) {
		?>
		<ol class="zyme-comments-area"><p class="center no-comment"><i class="zyme zyme-sofa"></i> 还没有任何评论，你来说两句吧!</p></ol>
		<?php } else { ?>
		<ol class="zyme-comments-area">
			<?php wp_list_comments('type=comment&callback=zyme_comment'); ?>
		</ol>
		<?php } ?>

		<?php if (get_option('page_comments')) { ?>
		<div id="pagination">
			<div class="zyme-comments-page">
