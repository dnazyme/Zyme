...
;(function (window, document, undefined) {
    ...
    function createIcons(elem, data) {
        ...
        each(isPrepend ? sites.reverse() : sites, function (name) {
            ...
            var link = data.initialized ? getElementsByClassName(elem, 'zyme-' + name) : createElementByString('<a class="social-share-icon zyme-' + name + '"></a>');
    ...
    function createWechat (elem, data) {
        var wechat = getElementsByClassName(elem, 'zyme-wechat', 'a');
