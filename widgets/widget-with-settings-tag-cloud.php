 ...
 * 小工具：标签云
 */
class zyme_widget_tag_cloud extends WP_Widget{
	...
	function __construct(){
		parent::__construct(
			'tag_cloud',
			'zyme标签云',
			array( 'description' => __( '显示任意分类法的条款', 'zyme' ) )
		);
...
?>
		...
		<p title="<?php esc_attr_e( '设置为 0 则全部显示', 'zyme' ); ?>">
			<label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php _e( '标签数量：', 'zyme' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'taxonomy' ) ); ?>"><?php _e( '分类法：', 'zyme' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'orderby' ) ); ?>"><?php _e( '标签排序：', 'zyme' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'order' ) ); ?>"><?php _e( '排序规则：', 'zyme' ); ?></label>
...
register_widget( 'zyme_widget_tag_cloud' );
