<?php
class zyme_widget_recent_visitors extends WP_Widget {
    ...
    function __construct(){
        parent::__construct(
            'recent_visitors',
            'zyme最近访客',
            array( 'description' => __( '根据设置可以显示不同数量的访客', 'zyme' ) )
        );
    ...
    function widget($args, $instance){
        ...
        if (function_exists('zyme_most_active_friends')) { echo "<ul class='widget-visitors'>" . zyme_most_active_friends($readerNum) . "</ul>";} ;
        echo $after_widget;  //框架结束
    }
}
register_widget('zyme_widget_recent_visitors');