 ...
 * 小工具：评论
 */
class zyme_widget_recent_comments extends WP_Widget{
	...
	function __construct(){
		parent::__construct(
			'recent_comments',
			'zyme最近评论' . __( '', 'zyme' ),
			array( 'description' => __( '根据设置可以显示不同的评论', 'zyme' ) )
		);
...
<?php
				...
				echo '<ul class="recentcomments">';
					foreach( $comments as $comment ):
						$a_title = sprintf( __( '「%s」', 'zyme' ), get_the_title( $comment->comment_post_ID ) );
?>
						<li>
...
?>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php _e( '评论数量：', 'zyme' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'exclude_users' ) ); ?>"><?php _e( '排除用户：', 'zyme' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'exclude_administrator' ) ); ?>"><?php _e( '排除所有管理员：', 'zyme' ); ?></label>
...
register_widget( 'zyme_widget_recent_comments' );
